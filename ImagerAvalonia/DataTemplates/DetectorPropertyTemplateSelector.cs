...
namespace ImagerAvalonia.DataTemplates
{

    public class DetectorPropertyTemplateSelector : IDataTemplate
    {
        ...
        public bool Match(object? data)
        {
            ...
            return data is DetectorEquipmentViewModelProperties                  // the provided data needs to be our enum type
