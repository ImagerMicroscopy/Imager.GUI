...
namespace ImagerAvalonia.DataTemplates
{
    ...
    public class MovablePropertyTemplateSelector : IDataTemplate
    {
        ...
        public bool Match(object? data)
        {
            ...
            return data is MovableEquipmentViewModelProperties               // the provided data needs to be our enum type
